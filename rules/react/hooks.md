---
globs: "admin/**/*.tsx,admin/**/*.jsx,admin/**/hooks/**/*.ts,admin/**/hooks/**/*.js,admin/**/use-*.ts,admin/**/use-*.tsx,store-app/**/*.tsx,store-app/**/*.jsx,store-app/**/hooks/**/*.ts,store-app/**/hooks/**/*.js,store-app/**/use-*.ts,store-app/**/use-*.tsx,store-kiosk/**/*.tsx,store-kiosk/**/*.jsx,store-kiosk/**/hooks/**/*.ts,store-kiosk/**/hooks/**/*.js,store-kiosk/**/use-*.ts,store-kiosk/**/use-*.tsx,web-app/**/*.tsx,web-app/**/*.jsx,web-app/**/hooks/**/*.ts,web-app/**/hooks/**/*.js,web-app/**/use-*.ts,web-app/**/use-*.tsx,health-dashboard/**/*.tsx,health-dashboard/**/*.jsx,health-dashboard/**/hooks/**/*.ts,health-dashboard/**/hooks/**/*.js,health-dashboard/**/use-*.ts,health-dashboard/**/use-*.tsx"
---
# React Hooks
