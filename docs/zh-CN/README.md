...
**搞定！** 你现在可以使用 24 个智能体、64 项技能和 41 个命令了。
...
|---------|---------------|----------|--------|
| 智能体 | PASS: 24 个    | PASS: 12 个 | **Claude Code 领先** |
| 命令 | PASS: 41 个    | PASS: 35 个 | **Claude Code 领先** |
| 技能 | PASS: 64 项   | PASS: 37 项 | **Claude Code 领先** |
...
|---------|-----------------------|------------|-----------|----------|
| **智能体** | 24                    | 共享 (AGENTS.md) | 共享 (AGENTS.md) | 12 |
| **命令** | 41                    | 共享 | 基于指令 | 35 |
| **技能** | 64                   | 共享 | 10 (原生格式) | 37 |
